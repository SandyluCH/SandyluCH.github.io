...
- Action `lockDrawingsAction` from [executeActionById](Chart-Methods.md#executeactionbyidactionid) and [getCheckableActionState](Chart-Methods.md#getcheckableactionstateactionid) method are removed. Use [lockAllDrawingTools](Widget-Methods.md#lockalldrawingtools) instead.
